        ...
        <main>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-12">
                    <form method="post" id="fetchForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" name="order_id" class="form-control" id="order_id" placeholder="Order Id" value="" required>
                            </div>

                        </div>
                </div>

                <button class="w-100 my-4 btn btn-primary btn-lg" type="button" id="fetchOrder">Fetch Order Details</button>
                </form>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#fetchOrder").click(function() {
            ...
            var formData = $("#fetchForm").serialize();
